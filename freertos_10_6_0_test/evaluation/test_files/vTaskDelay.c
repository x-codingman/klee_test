...
TickType_t KLEE_xTicksToDelay;
klee_make_symbolic_controllable(&KLEE_xTicksToDelay, sizeof(KLEE_xTicksToDelay), "KLEE_xTicksToDelay", true);
vTaskDelay(KLEE_xTicksToDelay);
return 0;
}
void vTaskFunction1( void *pvParameters )
{
