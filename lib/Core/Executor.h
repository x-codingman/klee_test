...
/// add 
  ...
  ref<Expr> jsonToExpr(ExecutionState &state, const MemoryObject* mo, std::string name, uint64_t relativeOffset, 
 ...
 void recordDereferenceLocationsToJson(ExecutionState &state, ref<Expr> address);
