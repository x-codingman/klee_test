            ...
            if os.path.isfile(info_file):
                with open(info_file, 'r') as file:
                    ...
                    try:
                        ...
                        df = df.append({'System Call': folder, 'Elapsed': time_tranform(elapsed), 'Explored Paths': explored_paths,'Total Instructions': total_instructions, 
                                        'Completed Paths': completed_paths, 'Partially Completed Paths': partially_completed_paths, 
                                        'Generated Tests': generated_tests}, ignore_index=True)
                    except IndexError:
                        # 如果格式不匹配，添加NA
...
test_rtos = 'FreeRTOS-Kernel-10.6.0'
#test_rtos = 'threadx'
directory_path = '/home/klee/'+ test_rtos + '/symbolic_execution/output'
dataframe = extract_info(directory_path)
print(dataframe)
dataframe.to_excel('/home/klee/klee_test/rtos-api-analysis/results/'+test_rtos+'-symbolic-execution-run-time-evaluation.xlsx', index=False)
