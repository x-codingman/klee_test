...
lor.lhs.false:                                    ; preds = %entry
  ...
  br i1 %cmp1, label %if.then, label %if.end6, !dbg !53

if.then:                                          ; preds = %lor.lhs.false, %entry
  %2 = load %struct.test_structure_2*, %struct.test_structure_2** %test_ptr_2.addr, align 8, !dbg !54
  %a = getelementptr inbounds %struct.test_structure_2, %struct.test_structure_2* %2, i32 0, i32 0, !dbg !57
  %3 = load i32, i32* %a, align 8, !dbg !57
  %cmp2 = icmp eq i32 %3, 0, !dbg !58
  br i1 %cmp2, label %if.then3, label %if.end, !dbg !59

if.then3:                                         ; preds = %if.then
  %4 = load %struct.test_structure_2*, %struct.test_structure_2** %test_ptr_2.addr, align 8, !dbg !60
  %b4 = getelementptr inbounds %struct.test_structure_2, %struct.test_structure_2* %4, i32 0, i32 1, !dbg !62
  %5 = load i32, i32* %b4, align 4, !dbg !62
  %6 = load i32*, i32** %b.addr, align 8, !dbg !63
  store i32 %5, i32* %6, align 4, !dbg !64
  %7 = load %struct.test_structure_2*, %struct.test_structure_2** %test_ptr_2.addr, align 8, !dbg !65
  %c5 = getelementptr inbounds %struct.test_structure_2, %struct.test_structure_2* %7, i32 0, i32 2, !dbg !66
  %8 = load i32, i32* %c5, align 8, !dbg !66
  %9 = load i32*, i32** %c.addr, align 8, !dbg !67
  store i32 %8, i32* %9, align 4, !dbg !68
  %10 = load i32*, i32** %c.addr, align 8, !dbg !69
  %11 = load i32, i32* %10, align 4, !dbg !70
  %12 = load i32*, i32** %b.addr, align 8, !dbg !71
  store i32 %11, i32* %12, align 4, !dbg !72
...
!55 = distinct !DILexicalBlock(scope: !56, file: !1, line: 18, column: 12)
!56 = distinct !DILexicalBlock(scope: !48, file: !1, line: 17, column: 97)
!57 = !DILocation(line: 18, column: 24, scope: !55)
!58 = !DILocation(line: 18, column: 26, scope: !55)
!59 = !DILocation(line: 18, column: 12, scope: !56)
!60 = !DILocation(line: 19, column: 18, scope: !61)
!61 = distinct !DILexicalBlock(scope: !55, file: !1, line: 18, column: 31)
!62 = !DILocation(line: 19, column: 30, scope: !61)
!63 = !DILocation(line: 19, column: 14, scope: !61)
!64 = !DILocation(line: 19, column: 16, scope: !61)
!65 = !DILocation(line: 20, column: 18, scope: !61)
!66 = !DILocation(line: 20, column: 30, scope: !61)
!67 = !DILocation(line: 20, column: 14, scope: !61)
!68 = !DILocation(line: 20, column: 16, scope: !61)
!69 = !DILocation(line: 21, column: 19, scope: !61)
!70 = !DILocation(line: 21, column: 18, scope: !61)
!71 = !DILocation(line: 21, column: 14, scope: !61)
!72 = !DILocation(line: 21, column: 16, scope: !61)
!73 = !DILocation(line: 22, column: 9, scope: !61)
!74 = !DILocation(line: 24, column: 5, scope: !56)
!75 = !DILocation(line: 25, column: 1, scope: !38)
