...
entry:
  ...
  %call = call i32 (%struct.test_structure_2*, i32*, i32*, ...) bitcast (i32 (...)* @test_api_2 to i32 (%struct.test_structure_2*, i32*, i32*, ...)*)(%struct.test_structure_2* %3, i32* %4, i32* %5), !dbg !36
  ret i32 0, !dbg !37
}
...
declare dso_local i32 @test_api_2(...) #2
